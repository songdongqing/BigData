 ...
 */
@Slf4j
public class SkillJob implements Runnable{
    public  void analyse() {
        log.info("开始分析职位要求情况");

        try {
            HbaseClient.truncateTable("skill");
            ...
            job.setJarByClass(SkillJob.class);
            job.setJobName("SkillJob");
...
//        FileInputFormat.addInputPaths(job,"/data/input/wordcount.txt");
            ...
            TableMapReduceUtil.initTableReducerJob("skill", SkillReducer.class, job);
