...
//        System.out.println(rs2.cookie("user_trace_token"));
//
//        String url3 = "https://a.lagou.com/collect?v=1&_v=j31&a=235517126&t=pageview&_s=1&dl=https%3A%2F%2Fwww.lagou.com%2F&ul=zh-cn&de=UTF-8&dt=%E4%BA%92%E8%81%94%E7%BD%91%E6%B1%82%E8%81%8C%E6%8B%9B%E8%81%98-%E4%B8%8A%E6%8B%89%E5%8B%BE-%E4%B8%93%E4%B8%9A%E7%9A%84%E4%BA%92%E8%81%94%E7%BD%91%E6%8B%9B%E8%81%98%E6%B1%82%E8%81%8C%E6%89%BE%E5%B7%A5%E4%BD%9C%E5%B9%B3%E5%8F%B0&sd=24-bit&sr=1366x768&vp=1349x151&je=0&_u=MEAAAAQBK~&jid=95121810&cid=1211432947.1586713714&tid=UA-41268416-1&_r=1&z=1015481132";
//
//        Connection connection3 = Jsoup.connect(url3)
////                .header("Accept","application/json, text/javascript, */*; q=0.01")//去掉中文乱码
////                .header("Accept-Encoding","gzip, deflate, br")
...
//                .cookies(rs.cookies())
//                .ignoreHttpErrors(true)  ;
//        Response rs3 = connection3.execute();
//        System.out.println(rs3.body());
//        System.out.println(rs3.cookies());
//
        String url4 = "https://www.lagou.com/utrack/track.js?version=1.0.1.0";

        Connection connection4 = Jsoup.connect(url4)
//                .header("Accept","application/json, text/javascript, */*; q=0.01")//去掉中文乱码
//                .header("Accept-Encoding","gzip, deflate, br")
//                .header("Accept-Language","zh-CN,zh;q=0.8,zh-TW;q=0.7,zh-HK;q=0.5,en-US;q=0.3,en;q=0.2")
//                .header("Connection","keep-alive")
...
//                .cookies(rs3.cookies())
                .ignoreHttpErrors(true);
        Response rs4 = connection4.execute();
...
//        webDriver.close();
//
//        engine.eval(rs4.body());
//
//        ScriptEngineManager manager = new ScriptEngineManager();
//        ScriptEngine engine = manager.getEngineByName( "JavaScript" );
//        System.out.println( engine.getClass().getName() );
//        System.out.println( "Result:" + engine.eval( rs4.body())+" _0xcb17dc('X_HTTP_TOKEN')");
...
////        HtmlPage page=webClient.getPage("https://www.lagou.com/");
////        System.out.println("page.getBody():\n"+page.getBody());
////        webClient.waitForBackgroundJavaScript(10000);
////        ScriptResult s = page.executeJavaScript(rs4.body());//执行js方法
////        System.out.println(JSON.toJSONString(s.getJavaScriptResult()));
        ...
        HtmlPage page = webClient.getPage(url4);
        webClient.getOptions().setTimeout(10000);
        webClient.waitForBackgroundJavaScript(4000);
        page.executeJavaScript(rs4.body());
